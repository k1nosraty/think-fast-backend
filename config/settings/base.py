...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        ...
        "guest_revoke": "60/hour",
        "guest_ws_ticket": "120/minute",
...
FRIENDLY_COUNTDOWN_SECONDS = integer("FRIENDLY_COUNTDOWN_SECONDS", 5)
PLAYER_CHALLENGE_SETUP_SECONDS = integer("PLAYER_CHALLENGE_SETUP_SECONDS", 120)
PARTY_SETUP_DURATION_SECONDS = integer("PARTY_SETUP_DURATION_SECONDS", 90)
PARTY_ROUND_DURATION_SECONDS = integer("PARTY_ROUND_DURATION_SECONDS", 60)
...
WS_TICKET_TTL_SECONDS = integer("WS_TICKET_TTL_SECONDS", 30)
RELIABILITY_WORKER_INTERVAL_SECONDS = integer("RELIABILITY_WORKER_INTERVAL_SECONDS", 1)
RESYNC_MAX_EVENTS = integer("RESYNC_MAX_EVENTS", 100)
RESYNC_BATCH_SIZE = integer("RESYNC_BATCH_SIZE", 50)
RESYNC_RATE_LIMIT_COUNT = integer("RESYNC_RATE_LIMIT_COUNT", 10)
RESYNC_RATE_LIMIT_WINDOW_SECONDS = integer("RESYNC_RATE_LIMIT_WINDOW_SECONDS", 10)
